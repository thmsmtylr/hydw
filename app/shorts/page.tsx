...
import { ShortsPageQuery } from "@/types/generated";
import { PageLayout } from "@/components/page-layout";
import { PageHeading } from "@/components/page-heading";
import { Parallax } from "@/components/parallax";
import { SHORTS_PAGE_QUERY } from "@/queries/shorts-page-page-query";
import { WiggleOnHover } from "@/components/wiggle-on-hover";

async function getPageData(): Promise<ShortsPageQuery> {
  const data = await request({ query: SHORTS_PAGE_QUERY });
  return { ...(data as ShortsPageQuery) };
}
