        ...
        <section className="page-grid smallspace">
          ...
          <div className="col-span-12 md:col-span-10 lg:col-span-4 lg:col-start-9">
            ...
            <div className="mt-7 lg:mt-0">
                <h6 className="smallbody uppercase">Created by</h6>
            ...
            <div className="mt-7">
                <h6 className="smallbody uppercase">Distributor</h6>
                <p className="body"><a href="">Grouse House</a></p>
            </div>
          </div>
        </section>
        <section className="largespace">
          <h4 className="heading4 uppercase mb-7">More web series that we've made</h4>
